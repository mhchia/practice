...
c = int(raw_input())
m = pow(c, d, n) # find c such that c^d (mod n) == flag value

# read the flag file, strip space and \n, and convert characters to ascii value, then turn hex value to decimal
